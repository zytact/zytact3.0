        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="space-y-12 lg:col-span-2">
              ...
              <motion.div variants={itemVariants}>
                ...
                <div className="text-muted-foreground space-y-4">
                  <p>
                    ...
                    products that make a difference. I started coding when I was
                    15, and ever since, I&apos;ve been obsessed with creating
                    things on the internet.
                  </p>
                  <p>
                    My journey has taken me through different eras, starting
                    from 2016 when React had just begun. Along the way,
                    I&apos;ve learned that the best products come from a deep
                    understanding of users and a relentless focus on quality.
                  </p>
                  <p>
                    When I&apos;m not coding, you&apos;ll find me contributing
                    to open source, writing about tech, or exploring new
                    technologies. I believe in building in public and sharing
              ...
              <motion.div variants={itemVariants}>
                ...
                <div className="space-y-6">
                  {experiences.map((exp, index) => (
                    ...
                    >
                      {/* Timeline dot */}
                      <div className="border-background absolute top-0 -left-[9px] h-4 w-4 rounded-full border-2 bg-emerald-500" />
              ...
              {/* Values */}
              <motion.div variants={itemVariants}>
                <h3 className="mb-6 text-lg font-semibold">What I Value</h3>
